<template>
  <el-row>
    <el-col :span="20">
      <div id="myChart" :style="{width: '100%', height: winHeight}"></div>
    </el-col>
    <el-col :span="4">
      <div :style="{height: textCardHeight}">
        <el-steps direction="vertical">
          <el-step v-for="item in textArray" :key="item.date" :title='item.date' :description='item.description'></el-step>
        </el-steps>
      </div>
    </el-col>
  </el-row>  
...
export default {
      ...
      geoJson: {
        ...
        features: [
          ...
          },
          {
            type: "Feature",
            id: "tai_wan",
            properties: { name: "台湾菜", cp: [121.0254, 23.5986], childNum: 1 },
            geometry: {
              type: "Polygon",
              coordinates: [
                [
  ...
  methods: {
    init(){
      this.winHeight=(document.body.clientHeight||document.documentElement.clientHeight)-5+'px'
      this.textCardHeight=this.textArray.length*100+'px'
    },
    drawLine() {
